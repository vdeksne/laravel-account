        ...
        no-underline hover:no-underline font-title" href="#" title="" aria-label="store logo">
            ...
            <div
                ...
                <div class="hidden lg:block lg:relative lg:min-h-0 lg:px-8 lg:w-auto lg:pt-0">
                    <nav class="w-full duration-150 ease-in-out transform flex justify-start w-auto relative min-h-0 transition-display navigation-main uppercase text-footer">
                        <div class="relative mr-2 level-0">
                            <span class="flex items-center block p-3 text-md bg-opacity-95">
                                <a data-test="header-link" class="w-full py-3 text-base hover:underline level-0 navigation-main"
            ...
            <div class="flex items-center order-3">
                ...
                >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                         class="w-8 h-8 md:h-6 md:w-6 header-icon" width="25" height="25">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
